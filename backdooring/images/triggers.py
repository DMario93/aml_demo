...
def overlay_trigger_on_images(images: torch.Tensor, trigger_path):
    ...
    for batch_index in tqdm.tqdm(range(batch_size)):
        ...
        images[batch_index, :, offset_x:offset_x + trigger.shape[1], offset_y:offset_y + trigger.shape[2]] = trigger
